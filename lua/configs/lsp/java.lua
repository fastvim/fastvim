--==============================================
-- Coded by:  Kevin Sookocheff
-- This code was taken from an article to avoid unnecessary complications

-- Article link: https://sookocheff.com/post/vim/neovim-java-ide/
-- for more information about jdtls visit: https://github.com/eclipse-jdtls/eclipse.jdt.ls/wiki/Running-the-JAVA-LS-server-from-the-command-line
--==============================================
